...
public class OdpsCallableStatement extends OdpsPreparedStatement implements CallableStatement {

    OdpsCallableStatement(OdpsConnection conn, String sql) {
        super(conn, sql);
    }
    ...
    @Override public Object getObject(int parameterIndex, Map<String, Class<?>> map)
        throws SQLException {
    ...
    @Override public Object getObject(String parameterName, Map<String, Class<?>> map)
        throws SQLException {
    ...
    @Override public Timestamp getTimestamp(String parameterName, Calendar cal)
        throws SQLException {
