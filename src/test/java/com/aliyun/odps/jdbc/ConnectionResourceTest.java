...
public class ConnectionResourceTest {
  ...
  public void testConnectionResourceTest() throws Exception {
    ...
    String url2 =
        "jdbc:odps:http://1.1.1.1:8100/api?project=p1&loglevel=debug&accessId=123&accessKey=234%3D&logview_host=http://abc.com:8080&tunnelEndpoint=http://1.1.1.1:8066&interactiveMode=true&interactiveServiceName=sn&interactiveTimeout=11&majorVersion=default1&logconffile="
            + logConfigFile;
